...
Original file is located at
    https://colab.research.google.com/drive/18OT7shW_Mg6GCFzSGJnVIVpV1-CIp2Jp
"""

import numpy as np

# Importante: verifica que tu nombre y número de matrícula esten correctos
nombre = "José Jesús Del Ángel Rodríguez"
numero_de_matricula = 175800
fecha = '2025-02-26'
...
def correlacion():
    df_tamaño = np.array([100, 120, 140, 160, 180, 200, 220, 240, 260, 280])
    df_precio = np.array([1305710, 1658277, 1894167, 2136552, 2298267, 2553624, 2780503, 	3289726, 3472743, 3779477])
    correlacion = np.corrcoef(df_tamaño, df_precio)[0,1]
    return correlacion
...
def problema_especifico():
    return ('Desarrollar modelos que ayuden a identificar tendencias y señales en el mercado de divisas para saber el mejor momento para comprar y vender divisas')

def importancia():
    return('Entender mejor los movimientos del mercado y con esto poder realizar operaciones seguras reduciendo bastante el riesgo de perdida')

def objetivos():
    return('Generar ganacias con el modelo, al igual que ir entendiendo mas sobre los movimientos y fluctuasiones del mercado, como resultado se espera obtener ganacias a mediano plazo al igual que un modelo estable y actualizable con el cual poder trabajar bastantes años')

def tipo_de_datos():
    return('Yo creo que para este proyecto se necesitaran los datos de varios años atras y de diferentes divisas todo esto con el fin de ampliar mas la base de datos del modelo teniendo mas opciones y un mejor analisis')
