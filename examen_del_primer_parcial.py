...
Original file is located at
    https://colab.research.google.com/drive/1iMdvQkoYvZQOiknIHcWDglhD3WYfgnzH
"""

import numpy as np

# Importante: verifica que tu nombre y número de matrícula esten correctos
nombre = "Carlos Gabriel Rodríguez Cardona"
numero_de_matricula = 177488
fecha = '2025-02-26'
...
def correlacion():
    ...
    return np.corrcoef(tamaño, precio)[0, 1]
...
def problema_especifico():
    return """
    Sirve para identificar patrones, tendencias o relaciones en el comportamiento de ventas,
    esto para poder optimizar la toma de decisiones importantes.
    """

def importancia():
    return """
    Es importante porque ayuda realmente para hacer un análisis exhaustivo de los datos,
    por ejemplo, todo esto para que sus ventas, logística y demás se vean optimizadas y beneficiadas.
    """

def objetivos():
    return """
    Analizar los datos históricos de las ventas, para predecir tendencias, patrones y demás optimizar el inventario.
    """

def tipo_de_datos():
    return """
    Se necesitarían datos de la ventas, del inventario, y cómo se comportan los clientes.
    """
