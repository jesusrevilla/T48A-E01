...
Original file is located at
    https://colab.research.google.com/drive/1O_L83cXhgZtck7Yu7BZtXYr5oCOzXhIa
"""

import numpy as np

# Importante: verifica que tu nombre y número de matrícula esten correctos
nombre = "Guillermo Ochoa de León"
numero_de_matricula = 176635
fecha = '2025-02-26'
...
def asistencia_dispersion():
  datos = [20100,24500,31600,28400,49500,19350,25600,30600,11300,28560]
...
asistencia_dispersion().__repr__()
...
def histograma_np():
  datos=[7.9, 7.8, 7.8, 6.7, 7.6, 8.7, 8.5, 7.3, 6.6, 9.9, 8.4, 7.2, 6.6, 5.7, 9.4, 8.4, 7.2, 6.3, 5.1, 4.8, 5.0, 6.1, 7.1, 8.2, 9.3, 10.0, 8.9]
  histograma = np.histogram(datos,bins=10)
...
# 44  76  120
# 104 146 250
  p_hombre = 130/250 #total hombre / total ambos
  p_po_hombre = 60/130 #primera ofensa / total hombre

  return (p_hombre,p_po_hombre)

probabilidad_condicional().__repr__()
...
def problema_especifico():
    ...
    return(''' 6. Saber que tipo de arte la gente esta interesada/le gusta y las horas en que es mas probable que llegue a estar en su linea de tiempo en las redes sociales ''')

def importancia():

    return(''' 7. Para poder tener un alcance mayor a mas gente y poder compartir intereses con mas personas ''')

def objetivos():

    return(''' 8.Lograr definir los temas destacables que la gente esta interesada y las horas del dia en que mas conviene publicar estas, ya que los algoritmos de las redes sociales dependen del tiempo y del alcance que tiene la cuenta
    9.Poder identificar temas que la gente desea ver y como hacer que estos lleguen a ellos ''')

def tipo_de_datos():

    return(''' 10.Diferentes pruebas a diferentes temas del dia y ademas diferentes temas, desde varias redes sociales. Los principales datos a extraer serian los numeros de alcance que se reportan por post y las hora y el dia de la semana en que son publicadas ''')
