# -*- coding: utf-8 -*-
"""174074 Examen del primer parcial.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14qoNJ2KuzszSWeEtU4cNcEnHezn8Gz3K
"""
...
def probabilidad_condicional():
    primera_ofensa_hombre = 60
    reincidente_hombre = 70
    primera_ofensa_mujer = 44
    reincidente_mujer = 76

    total=primera_ofensa_hombre + reincidente_hombre + primera_ofensa_mujer + reincidente_mujer

    p_hombre = (primera_ofensa_hombre + reincidente_hombre) / total

    p_po_hombre = primera_ofensa_hombre / (primera_ofensa_hombre + reincidente_hombre)
